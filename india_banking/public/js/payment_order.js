frappe.ui.form.on("Payment Order", {
		...
		if (
			...
			if (has_initiated_or_non_pending) {
				...
				frm.add_custom_button(__("Get Status"), () => {
					frappe.call({
						method:
							"india_banking.india_banking.doctype.banking_backend_connector.banking_backend_connector.get_payment_status",
						freeze: true,
	...
	make_payment: function (frm) {
		frappe.call({
			method:
				"india_banking.india_banking.doctype.banking_backend_connector.banking_backend_connector.make_payment",
			freeze: true,
